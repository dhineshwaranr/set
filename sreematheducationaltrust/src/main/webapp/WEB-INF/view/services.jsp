...
<div class="container">
	...
	<div class="row whatWeDo">
		<div class="service col-lg-4 col-md-12 col-sm-12 col-xs-12">
			...
			<div>
				<p>All students need access to a high-quality, rigorous K-12 education to prepare for the opportunities and demands of the world outside of school doors. But too many young people — disproportionately African American, Latino, and Native students and students from low-income families — are getting an education that falls far short.</p>
			</div>
			<button type="button" class="btn btn-primary btn-lg sharp pull-right">Know More</button>
		</div>
		<div class="service col-lg-4 col-md-12 col-sm-12 col-xs-12">
			<div class="headingStyle1">
				<span><a href="#">K-12 Policy & Practice</a></span>
